//
//  I_will_test_my_appsAppDelegate.m
//  I_will_test_my_apps
//
...
@implementation I_will_test_my_appsAppDelegate

@synthesize window;
@synthesize navigationController;
@synthesize coreDataStackHelper;
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSString *modelPath = [[NSBundle mainBundle] pathForResource:@"I_will_test_my_apps" ofType:@"momd"];
...
{    
	...
	[self setCoreDataStackHelper: nil];
